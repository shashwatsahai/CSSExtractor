/*Shashwat Sahai
ssahai97@gmail.com
github:https://github.com/shashwatsahai/
*/
    ...
    function getCssTxt(ele){
        ...
        for (x = 0; x < document.styleSheets.length; x++) {
            ...
            if (rules === null) {
                ...
                last='/* rules null of stylesheet'+(x+1)+'/'+document.styleSheets.length+'*/\n';
                continue;
            };
            ...
            for (i = 0; i < rules.length; i++) {
                ...
                if(arrSelMatched.length>0){
                    arrCss.push(rules[i].cssText
                                ...
                                +'\n');
                    currstyle.push(rules[i].cssText
                      .replace(rules[i].selectorText, arrSelMatched.join(','))
                      .replace(/\}$/,function(){
                          return chromeBugFix(rules[i])
                      })
            ...
            for (j = 0; j < keyFramUsed.length; j++) {
                for (k = 0; k < keyFramUsed[j].length; k++) {
                    if(keyFram[i].name===keyFramUsed[j][k]){
                        ...
                        currstyle.push(keyFram[i].cssText);
                    };
                };
            };
        };
...
(function (root, factory) {
  ...
  function writedata(){
    ...
    filename = name || 'download';//Give your filename here
